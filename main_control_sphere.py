...
if __name__ == '__main__':
    ...
    # Initialize lists to track success counts and reaching times
    success_counts = []
    reaching_times = []
    ...
    for i in range(num_environments):
        ...
        for mode in control_modes:
            ...
            trial_success, trial_time, goal_distances, estimated_obstacle_distances = main(jax_params, env, robot, dt, mode, env_idx=i, interactive_window=args.interactive_window)


            # Track success counts and reaching times
            success_counts.append(trial_success)
            reaching_times.append(trial_time)
